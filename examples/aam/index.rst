...
parts that are ready and safe to use immediately (i.e., “born qualified”). This
project enables secure, automated, time-sensitive interactions between
...
develop process parameters for new alloys and geometries. The :term:`AAM`
system is deployed at :term:`Oak Ridge National Laboratory<ORNL>`\'s
:term:`Manufacturing Demonstration Facility (MDF)<MDF>`, :term:`Spallation
Neutron Source Facility (SNS)<SNS>`, and :term:`Oak Ridge Leadership Computing
Facility (OLCF)<OLCF>` as a cross-facility instrument-science workflow.
