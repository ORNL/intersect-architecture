...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
   ...
   xmlns:xsd="http://www.w3.org/2001/XMLSchema" version="1.0" exclude-result-prefixes="xsl xi xs vc">
   ...
   <xsl:param name="useJavaScript">false</xsl:param>
...
<xsl:template match="xsd:complexType" mode="hierarchy">
   <xsl:text>\begin{longtable}[]{@{}p{1in}p{\textwidth-1in}@{}}&#xa;</xsl:text>
   <!-- Print super types -->
   <xsl:choose>
...
<!--
    Helper template for template, match="xsd:group[@ref]" mode="sample". Basically prints out a group reference, for 
...
<xsl:template match="xsd:attribute[@ref]" mode="schemaComponent">
   <xsl:param name="margin">2</xsl:param>
...
<xsl:template match="xsd:attributeGroup[@ref]" mode="schemaComponent">
   <xsl:param name="margin">3</xsl:param>
...
<xsl:template match="xsd:element[@ref]" mode="schemaComponent">
   <xsl:param name="margin">4</xsl:param>
...
<xsl:template match="xsd:group[@ref]" mode="schemaComponent">
   <xsl:param name="margin">5</xsl:param>
...
<xsl:template match="xsd:appinfo | xsd:documentation" mode="schemaComponent">
   <xsl:param name="margin">6</xsl:param>
...
<xsl:template match="xsd:keyref" mode="schemaComponent">
   <xsl:param name="margin">7</xsl:param>
...
<xsl:template match="xsd:extension | xsd:restriction" mode="schemaComponent">
   <xsl:param name="margin">8</xsl:param>
...
<xsl:template match="xsd:list" mode="schemaComponent">
   <xsl:param name="margin">9</xsl:param>
...
<xsl:template match="xsd:union" mode="schemaComponent">
   <xsl:param name="margin">10</xsl:param>
...
<xsl:template match="xsd:schema" mode="schemaComponent">
   <xsl:param name="margin">11</xsl:param>
...
<xsl:template match="*" mode="schemaComponent">
   <xsl:param name="margin">12</xsl:param>
...
<xsl:template match="comment()" mode="schemaComponent">
   <xsl:param name="margin">13</xsl:param>
   ...
   <xsl:variable name="content">
      <xsl:choose>
         ...
         <xsl:when test="$includeFilter!=''">
            ...
            <div class="scContent" style="margin-left: {$ELEM_INDENT}em">...3</div>
         </xsl:when>
...
<xsl:output method="text" encoding="ISO-8859-1" standalone="yes" version="1.0" doctype-public="-//W3C//DTD XHTML 1.0 Strict//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd" indent="yes"/>
...
<xsl:variable name="ELEM_INDENT">1</xsl:variable>
...
<xsl:template match="xsd:schema" mode="namespaces">
<xsl:text>\begin{longtable}[]{@{}p{1in}p{\textwidth-1in}@{}}&#xa;</xsl:text>
<xsl:text disable-output-escaping="yes">Prefix                                                       <![CDATA[&]]> Namespace \\&#xa;</xsl:text>
<!-- Default namespace (no prefix) -->
<xsl:if test="namespace::*[local-name(.)='']">
   <xsl:variable name="ns" select="namespace::*[local-name(.)='']"/>
   <a name="{$NS_PREFIX}">Default namespace</a>
...
<!--
      ...
      -->
<xsl:template match="xsd:schema" mode="schemaComponent">
<xsl:param name="margin">15</xsl:param>
...
<xsl:template match="xsd:schema" mode="properties">
<xsl:text>\begin{longtable}[]{@{}>{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5000}}>{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5000}}@{}}%&#xa;</xsl:text>
...
<!-- Element/Attribute Form Defaults -->
<xsl:text>Element and Attribute Namespaces</xsl:text>
<xsl:text disable-output-escaping="yes"><![CDATA[&]]>&#xa;</xsl:text>
<xsl:text>\begin{itemize}&#xa;</xsl:text>
<xsl:text>\item Global element and attribute declarations belong to this schema's target namespace.&#xa;</xsl:text>
<xsl:choose>
   <xsl:when test="normalize-space(@elementFormDefault)='qualified'">
      <xsl:text>\item By default, local element declarations belong to this schema's target namespace.&#xa;</xsl:text>
   </xsl:when>
   <xsl:otherwise>
      <xsl:text>\item By default, local element declarations have no namespace.&#xa;</xsl:text>
   </xsl:otherwise>
</xsl:choose>
<xsl:choose>
   <xsl:when test="normalize-space(@attributeFormDefault)='qualified'">
      <xsl:text>\item By default, local attribute declarations belong to this schema's target namespace.&#xa;</xsl:text>
   </xsl:when>
   <xsl:otherwise>
      <xsl:text>\item By default, local attribute declarations have no namespace.&#xa;</xsl:text>
   </xsl:otherwise>
</xsl:choose>
...
<xsl:text>\subsubsection{Schema Document Properties}&#xa;</xsl:text>
<xsl:apply-templates select="." mode="properties" />
<xsl:text>\paragraph{Declared Namespaces}&#xa;</xsl:text>
<xsl:apply-templates select="." mode="namespaces"/>
<!-- Declarations -->
<xsl:if test="xsd:attribute or xsd:element">
   <xsl:text>\subsubsection{Global Declarations}&#xa;</xsl:text>
...
<!-- Definitions -->
<xsl:if test="xsd:attributeGroup or xsd:complexType or xsd:group or xsd:notation or xsd:simpleType">
   <xsl:text>\subsubsection{Global Definitions}&#xa;</xsl:text>
...
<!--
     ...
     element declaration.
     -->
<xsl:template match="xs:element" mode="properties">
<xsl:text>\begin{longtable}[]{@{}p{1in}p{\textwidth-1in}@{}}&#xa;</xsl:text>
<!-- name -->
<xsl:text>Name &#38; </xsl:text>
<xsl:value-of select="@name" />
...
<!-- Box Title -->
<xsl:text>\begin{mdframed}[style=xml-block,frametitle={</xsl:text>
<xsl:value-of select="$caption"/>
<xsl:text>}]&#xa;</xsl:text>
<xsl:text>\begin{lstlisting}[language=XML]&#xa;</xsl:text>
<!-- Box Contents -->
