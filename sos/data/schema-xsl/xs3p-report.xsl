...
@import url(</xsl:text><xsl:value-of select="$externalCSSURL"/><xsl:text>);
	    ...
	    -->
            ...
            <h3><a name="SchemaProperties">Schema Document Properties</a></h3>
            <!-- Sub-section: Properties table -->
            <xsl:apply-templates select="." mode="properties"/>
            <!-- Sub-section: Namespace Legend -->
            <h4>Declared Namespaces</h4>
            ...
            <xsl:if test="xsd:redefine">
               <h3><a name="Redefinitions">Redefined Schema Components</a></h3>
            ...
            <xsl:choose>
               ...
               <xsl:when test="normalize-space(translate($sortByComponent,'TRUE','true'))='true'">
                  ...
                  <xsl:if test="xsd:attribute or xsd:element">
                     <h3><a name="SchemaDeclarations">Global Declarations</a></h3>
                  ...
                  <xsl:if test="xsd:attributeGroup or xsd:complexType or xsd:group or xsd:notation or xsd:simpleType">
                     <h3><a name="SchemaDefinitions">Global Definitions</a></h3>
               ...
               <xsl:otherwise>
                  <h3><a name="SchemaComponents">Global Schema Components</a></h3>
...
.footer {
   ...
   <xsl:template name="Legend">
      ...
      <div style="float: left; width: 15em;">
         <h4 style="margin-bottom: 0px;">Complex Type:</h4>
         <div class="hint" style="margin-left: 0em;">Schema Component Type</div>
      </div>
      <div style="float: left; width: 15em;">
         <h4 style="margin-bottom: 0px;"><span class="name">AusAddress</span></h4>
